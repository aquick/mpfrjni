...
#define __GMP_CFLAGS "-O2 -g -pedantic -fomit-frame-pointer -Wa,--noexecstack -ffunction-sections -funwind-tables -no-canonical-prefixes -fno-strict-aliasing -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -isystem c:\\android-ndk-r18b\\sysroot\\usr\\include -isystem c:\\android-ndk-r18b\\sysroot\\usr\\include\\arm-linux-androideabi --sysroot=c:\\android-ndk-r18b\\platforms\\android-19\\arch-arm -D__ANDROID_API__=19"
